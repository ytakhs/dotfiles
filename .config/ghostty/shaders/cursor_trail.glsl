...
// Original: https://github.com/sahaj-b/ghostty-cursor-shaders
// License: MIT (Copyright sahaj-b)
//
// -- CONFIGURATION --
...
const float THRESHOLD_MIN_DISTANCE = 4.0; // min distance to show trail (units of cursor width)
...
// --- EASING FUNCTIONS ---
// Uncomment the one you want to use (only one should be active)
